...
public class MapGraph {
	...
	HashMap<MapNode, List<MapNode>> mapAdjList ;
	List<MapEdge> edges;
	...
	public MapGraph()
	{
		...
		mapAdjList =  new HashMap<MapNode, List<MapNode>>();
	...
	{
		//TODO: Implement this method in WEEK 3
		Set<MapNode> allVertexNodes = mapAdjList.keySet();
		Set<GeographicPoint> allGeoPoints = new HashSet<>(); 
		for(MapNode v : allVertexNodes){
	...
	{
		// TODO: Implement this method in WEEK 3
		Set<MapNode> keys = mapAdjList.keySet();
		for (MapNode k : keys) {
		...
		List<MapNode> newNeighbors = new LinkedList<>();
		mapAdjList.put(newMapNode, newNeighbors);
		//add to lookup
		vertices.put(location, newMapNode);
		return true; 
	}
	...
	public void addEdge(GeographicPoint from, GeographicPoint to, String roadName,
		...
		MapNode fromIn = getNodeByGeo(from);
		MapNode toIn = getNodeByGeo(to);
	...
	public MapNode getNodeByGeo(GeographicPoint pointIn) {
		MapNode result = null;
		Set<MapNode> keys = mapAdjList.keySet();
		for (MapNode k : keys) {
